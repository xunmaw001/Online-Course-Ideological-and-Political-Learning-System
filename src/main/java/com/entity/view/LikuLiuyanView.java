 ...
 */
@TableName("liku_liuyan")
public class LikuLiuyanView extends LikuLiuyanEntity implements Serializable {
	...
	public LikuLiuyanView() {

	}

	public LikuLiuyanView(LikuLiuyanEntity likuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, likuLiuyanEntity);
