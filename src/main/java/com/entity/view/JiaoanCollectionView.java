...
public class JiaoanCollectionView extends JiaoanCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 类型的值
		*/
		private String jiaoanCollectionValue;
	...
	public JiaoanCollectionView(JiaoanCollectionEntity jiaoanCollectionEntity) {
		try {
			...
			* 获取： 类型的值
			*/
			public String getJiaoanCollectionValue() {
				return jiaoanCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setJiaoanCollectionValue(String jiaoanCollectionValue) {
				this.jiaoanCollectionValue = jiaoanCollectionValue;
			}
