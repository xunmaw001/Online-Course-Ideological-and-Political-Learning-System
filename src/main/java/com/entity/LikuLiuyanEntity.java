...
public class LikuLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public LikuLiuyanEntity() {

	}

	public LikuLiuyanEntity(T t) {
		try {
     ...
     * 留言内容
     */
    @TableField(value = "liku_liuyan_text")
