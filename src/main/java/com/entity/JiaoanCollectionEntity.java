...
public class JiaoanCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JiaoanCollectionEntity() {

	}

	public JiaoanCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "JiaoanCollection{" +
            "id=" + id +
            ", jiaoanId=" + jiaoanId +
            ", yonghuId=" + yonghuId +
            ", jiaoanCollectionTypes=" + jiaoanCollectionTypes +
