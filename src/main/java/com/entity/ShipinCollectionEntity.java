...
public class ShipinCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShipinCollectionEntity() {

	}

	public ShipinCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "ShipinCollection{" +
            "id=" + id +
            ", shipinId=" + shipinId +
            ", yonghuId=" + yonghuId +
            ", shipinCollectionTypes=" + shipinCollectionTypes +
