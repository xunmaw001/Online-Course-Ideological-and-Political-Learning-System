    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="likuLiuyanText">
                        <el-input type="textarea"  :readonly="ro.likuLiuyanText" v-model="ruleForm.likuLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.likuLiuyanText" label="留言内容" prop="likuLiuyanText">
                            <span v-html="ruleForm.likuLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='likuLiuyanText'){
                          this.ruleForm.likuLiuyanText = obj[o];
                          this.ro.likuLiuyanText = true;
                          continue;
                      }
                      if(o=='replyText'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`likuLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.likuLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
