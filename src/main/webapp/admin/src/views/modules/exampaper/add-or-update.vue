            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="试卷总分数" prop="exampaperMyscore">
                        <el-input v-model="ruleForm.exampaperMyscore"
                                  placeholder="试卷总分数" clearable value='0' readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="试卷状态" prop="exampaperTypes">
                        <el-select v-model="ruleForm.exampaperTypes" placeholder="请选择试卷状态">
                            <el-option
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                        ...
                        if(o=='exampaperDate'){
                            this.ruleForm.exampaperDate = obj[o];
                            this.ro.exampaperDate = true;
                            continue;
                        }
                        if(o=='exampaperMyscore'){
                            this.ruleForm.exampaperMyscore = obj[o];
                            this.ro.exampaperMyscore = true;
                            continue;
                        }
                        if(o=='exampaperTypes'){
