...
<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='shipin'">
                    <el-form-item class="select" v-if="type!='info'"  label="视频" prop="shipinId">
                        <el-select v-model="ruleForm.shipinId" filterable placeholder="请选择视频" @change="shipinChange">
                            <el-option
                                    v-for="(item,index) in shipinOptions"
                                    v-bind:key="item.id"
                                    :label="item.shipinName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='shipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="视频标题" prop="shipinName">
                        <el-input v-model="shipinForm.shipinName"
                                  placeholder="视频标题" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="视频标题" prop="shipinName">
                            <el-input v-model="ruleForm.shipinName"
                                      placeholder="视频标题" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24" v-if="sessionTable !='shipin' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shipinPhoto" label="视频照片" prop="shipinPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (shipinForm.shipinPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='shipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="视频类型" prop="shipinValue">
                        <el-input v-model="shipinForm.shipinValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='shipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="shipinClicknum">
                        <el-input v-model="shipinForm.shipinClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="shipinClicknum">
                            <el-input v-model="ruleForm.shipinClicknum"
            ...
            <input id="shipinId" name="shipinId" type="hidden">
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="shipinCollectionTypes">
                        <el-select v-model="ruleForm.shipinCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in shipinCollectionTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="类型" prop="shipinCollectionValue">
                        <el-input v-model="ruleForm.shipinCollectionValue"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shipin_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shipinCollectionTypesOptions = data.data.list;
                    }
                });

         this.$http({
             url: `shipin/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.shipinOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shipinId'){
                          this.ruleForm.shipinId = obj[o];
                          this.ro.shipinId = true;
                          continue;
                      }
                      if(o=='yonghuId'){
                      ...
                      if(o=='shipinCollectionTypes'){
                          this.ruleForm.shipinCollectionTypes = obj[o];
                          this.ro.shipinCollectionTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            info(id) {
                this.$http({
                    url: `shipinCollection/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.ruleForm = data.data;
                        this.shipinChange(data.data.shipinId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shipinCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shipinCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
