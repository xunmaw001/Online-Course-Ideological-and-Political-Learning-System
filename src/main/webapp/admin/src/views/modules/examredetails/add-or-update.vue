        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '开始分值' : ''">
                        <el-input v-model="searchForm.examquestionScoreStartSearch"
                                  placeholder="请输入开始分值" clearable></el-input>
                    </el-form-item>
                    <el-form-item :label="contents.inputTitle == 1 ? '' : ''">
                        =》
                    </el-form-item>
                    <el-form-item :label="contents.inputTitle == 1 ? '结束分值' : ''">
                        <el-input v-model="searchForm.examquestionScoreEndSearch"
                                  placeholder="请输入结束分值" clearable></el-input>
                    </el-form-item>
