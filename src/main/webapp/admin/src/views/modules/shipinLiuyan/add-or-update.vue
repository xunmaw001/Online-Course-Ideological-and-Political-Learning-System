    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="shipinLiuyanText">
                        <el-input type="textarea"  :readonly="ro.shipinLiuyanText" v-model="ruleForm.shipinLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shipinLiuyanText" label="留言内容" prop="shipinLiuyanText">
                            <span v-html="ruleForm.shipinLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shipinLiuyanText'){
                          this.ruleForm.shipinLiuyanText = obj[o];
                          this.ro.shipinLiuyanText = true;
                          continue;
                      }
                      if(o=='replyText'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shipinLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shipinLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
