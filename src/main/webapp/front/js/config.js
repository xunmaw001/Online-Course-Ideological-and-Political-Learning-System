...
var centerMenu = [
    ...
    ,{
        name: '教案收藏',
        url: '../jiaoanCollection/list.html'
    }
    ,{
        name: '案例库收藏',
        url: '../likuCollection/list.html'
    }
    ,{
        name: '视频收藏',
        url: '../shipinCollection/list.html'
    }
    ...
    ,{
        name: '错题表',
        url: '../examrewrongquestion/list.html'
    }
]
...
var indexNav = [
    ...
    {
        name: '教案',
        url: './pages/jiaoan/list.html'
    },
    {
        name: '案例库',
        url: './pages/liku/list.html'
    },
    {
        name: '视频',
...
var adminurl =  "http://localhost:8080/wangluoke/admin/dist/index.html#/login";
